...
const destinations: Destination[] = [
  ...
  { id: "volcanoes", label: "Volcanoes NP", country: "rwanda", cx: 400, cy: 910 },
  { id: "akagera", label: "Akagera", country: "rwanda", cx: 490, cy: 930 },
  { id: "nyungwe", label: "Nyungwe Forest", country: "rwanda", cx: 370, cy: 990 },
];
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="relative">
            ...
            >
              ...
              <g transform="translate(330, 870) scale(0.2)">
                <path
              ...
              {/* Rwanda label */}
              <text x="430" y="960" textAnchor="middle" className="fill-secondary/20 text-[20px] font-serif tracking-[0.15em] uppercase select-none pointer-events-none">
                Rwanda
              </text>
