...
interface Destination {
  ...
  /** x,y in Uganda SVG coord space (viewBox 0 0 1000 1000) */
  cx: number;
  cy: number;
}

/* Pin positions mapped to real geographic locations on the simplemaps Uganda SVG (viewBox 0 0 1000 1000).
   Rwanda pins are offset: rwX = rx * 0.38 + 280, rwY = ry * 0.33 + 720  (approx placement below Uganda) */
const destinations: Destination[] = [
  ...
  // Rwanda destinations (positioned in the Rwanda SVG area below)
  { id: "volcanoes", label: "Volcanoes NP", country: "rwanda", cx: 430, cy: 830 },
  { id: "akagera", label: "Akagera", country: "rwanda", cx: 620, cy: 900 },
  { id: "nyungwe", label: "Nyungwe Forest", country: "rwanda", cx: 410, cy: 980 },
];
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="relative">
            ...
            >
              ...
              {/* Rwanda label */}
              <text x="460" y="920" textAnchor="middle" className="fill-secondary/20 text-[20px] font-serif tracking-[0.15em] uppercase select-none pointer-events-none">
                Rwanda
              </text>
                  ...
                  >
                    ...
                    <text
                      ...
                      className={`text-[12px] font-semibold transition-all duration-300 select-none ${
                        isActive ? "fill-secondary" : "fill-foreground/50"
                      }`}
                    >
                      {dest.label}
                    </text>
            ...
            <AnimatePresence mode="wait">
              {activeDest && activeTrips.length > 0 ? (
                ...
                >
                  ...
                  <h3 className="font-serif text-xl text-foreground mb-2">Select a Destination</h3>
