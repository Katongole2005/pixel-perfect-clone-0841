...
/* Pin positions mapped to real geographic locations on the simplemaps Uganda SVG (viewBox 0 0 1000 1000).
   Rwanda is positioned adjacent to southwestern Uganda to reflect true regional proximity. */
const destinations: Destination[] = [
  ...
  { id: "volcanoes", label: "Volcanoes NP", country: "rwanda", cx: 330, cy: 760 },
  { id: "akagera", label: "Akagera", country: "rwanda", cx: 420, cy: 800 },
  { id: "nyungwe", label: "Nyungwe Forest", country: "rwanda", cx: 315, cy: 860 },
];
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="relative">
            ...
            >
              ...
              <g transform="translate(250, 690) scale(0.2)">
                <path
              ...
              {/* Rwanda label */}
              <text x="360" y="845" textAnchor="middle" className="fill-secondary/20 text-[20px] font-serif tracking-[0.15em] uppercase select-none pointer-events-none">
                Rwanda
              </text>
