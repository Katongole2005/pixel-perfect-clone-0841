...
export function SignInCard({ onSubmit, isLoading, logoUrl }: SignInCardProps) {
    ...
    return (
        <div className="min-h-screen w-full bg-white dark:bg-neutral-950 relative overflow-hidden flex items-center justify-center">
            <div className="absolute inset-0 z-0 text-slate-950 dark:text-white">
