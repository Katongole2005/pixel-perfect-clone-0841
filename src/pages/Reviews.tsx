        ...
        <>
            ...
            <div className="bg-background min-h-screen">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Button size="lg" className="bg-brand-earth hover:bg-brand-earth/90 text-primary-foreground font-body font-bold rounded-full px-8 h-14 shadow-xl shadow-brand-earth/20">
                                        Write a Review
                                    </Button>
                                    <div className="flex items-center gap-3 px-6 h-14 rounded-full border border-foreground/10 bg-background/50 backdrop-blur-sm">
                                        <div className="flex -space-x-2">
                                            {[1, 2, 3, 4].map(i => (
                                                <div key={i} className="w-8 h-8 rounded-full border-2 border-background bg-slate-300 overflow-hidden ring-2 ring-brand-earth/20" />
                                            ))}
                                        </div>
                            ...
                            <motion.div
                                ...
                                className="relative"
                            >
                                <GlowCard className="bg-brand-earth/5 border-brand-earth/10 p-8 rounded-3xl backdrop-blur-md">
                                    <div className="flex flex-col items-center text-center">
                                        <div className="text-7xl font-display font-bold text-brand-earth mb-2">
                                            {stats.averageRating}
                                        </div>
                                        <div className="flex gap-1 mb-4 text-brand-earth">
                                        ...
                                        <div className="w-full space-y-3">
                                            {[
                                                { label: "Excellent", percentage: 98, color: "bg-brand-earth" },
                                                { label: "Great", percentage: 2, color: "bg-brand-earth/60" },
                                                { label: "Average", percentage: 0, color: "bg-brand-earth/30" },
                                            ].map((bar, i) => (
                                ...
                                <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-brand-earth/10 rounded-full blur-3xl animate-pulse" />
                            </motion.div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 justify-between items-center">
                            ...
                            <div className="relative w-full md:w-64">
                                ...
                                <Input
                                    ...
                                    className="pl-10 rounded-full border-foreground/10 focus:ring-brand-earth"
                                    value={searchQuery}
                            ...
                            <div className="columns-1 sm:columns-2 lg:columns-3 gap-8 space-y-8">
                                <AnimatePresence mode="popLayout">
                                    {filteredReviews.map((review, idx) => (
                                        ...
                                        >
                                            <GlowCard className="group bg-background border border-foreground/5 p-6 rounded-3xl hover:border-brand-earth/30 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-brand-earth/5">
                                                <div className="flex justify-between items-start mb-4">
                                                    <div className="flex gap-1 text-brand-earth">
                                                ...
                                                <h3 className="text-xl font-display font-bold text-foreground mb-3 group-hover:text-brand-earth transition-colors duration-300">
                                                    {review.title}
                                                </h3>

                                                <div className="relative mb-6">
                                                    <Quote className="absolute -top-2 -left-2 w-8 h-8 text-brand-earth/10 -z-10" />
                                                ...
                                                <div className="pt-6 border-t border-foreground/5">
                                                    <div className="flex items-center gap-3 mb-4">
                                                        <div className="w-10 h-10 rounded-full bg-brand-earth/10 flex items-center justify-center text-brand-earth font-bold">
                ...
                <section className="py-32 bg-primary relative overflow-hidden">
                    <div className="absolute inset-0 bg-brand-earth/5 blur-[120px] rounded-full translate-x-1/2" />
                    <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button size="lg" className="bg-brand-earth hover:bg-brand-earth/90 text-primary-foreground font-body font-bold rounded-full px-12 h-16 text-lg">
                                    Rate Us on Google
                                </Button>
